...
export default class Chat extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            data: [
                { id: 1, date: "9:50 am", type: 'in', message: "Lorem ipsum dolor sit ametsdf jsdk jlsdjfl lsdfjl saljflsa jlsjfl sldj lsjdlfj sldjfl sdlj" },
                { id: 2, date: "9:50 am", type: 'out', message: "Hi" },
